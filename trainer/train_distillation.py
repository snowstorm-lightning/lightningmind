...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="LightningMind Knowledge Distillation")
    ...
    parser.add_argument("--wandb_project", type=str, default="LightningMind-Distillation", help="wandb项目名")
    ...
    lm_config_student = LightningMindConfig(hidden_size=args.student_hidden_size, num_hidden_layers=args.student_num_layers, use_moe=bool(args.use_moe))
    lm_config_teacher = LightningMindConfig(hidden_size=args.teacher_hidden_size, num_hidden_layers=args.teacher_num_layers, use_moe=bool(args.use_moe))
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"LightningMind-Distill-S{args.student_hidden_size}T{args.teacher_hidden_size}-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
