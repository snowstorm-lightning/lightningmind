...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="LightningMind Reasoning Distillation")
    ...
    parser.add_argument("--wandb_project", type=str, default="LightningMind-Reasoning", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"LightningMind-Reasoning-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
