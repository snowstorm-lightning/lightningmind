...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="LightningMind LoRA Fine-tuning")
    ...
    parser.add_argument("--wandb_project", type=str, default="LightningMind-LoRA", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"LightningMind-LoRA-{args.lora_name}-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
