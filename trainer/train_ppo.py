...
# 自定义的Critic模型，继承自LightningMindLM
class CriticModel(LightningMindForCausalLM):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="LightningMind PPO (Proximal Policy Optimization)")
    ...
    parser.add_argument("--wandb_project", type=str, default="LightningMind-PPO", help="wandb项目名")
    ...
    lm_config = LightningMindConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=bool(args.use_moe))
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"LightningMind-PPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
